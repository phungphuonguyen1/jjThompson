...
def load_view():
    ...
    ses1= """<div id="section1">
        ...
        <div class="text">
                ...
                <p class='styled-paragraph'>Vào năm 1897, Thomson đã chỉ ra rằng các tia phát ra từ ca-tốt được tạo bởi các hạt chưa biết mang điện tích âm (ngày nay, chúng ta gọi nó là electron). Với các hạt này, ông đã tính được rằng kích thước của chúng là rất nhỏ so với kích thước 1 nguyên tử và
    ...
    ses2="""<div id="section2">
            ...
            <p class="styled-paragraph">Vào năm 1897, J.J. Thomson đã phát hiện ra rằng chùm tia ca-tốt có thể bị ảnh hưởng bởi điện trường. 
            Bằng cách cân bằng giữa ảnh hưởng của từ trường và điện trường với chùm tia trên, Thomson đã chỉ ra rằng các “tia” ca-tốt thực ra là một chùm hạt. 
            Thí nghiệm này cũng đưa ra tỷ số giữa điện tích và khối lượng của hạt kể trên- về sau chúng ta gọi đó là electron. </p>
            <p class='styled-paragraph'> Cũng với thí nghiệm này, Thomson phát hiện ra rằng tỷ số trên là không đổi khi ông thay thế kim loại làm ca-tốt và a-nốt và loại khí chứa trong ống. 
            Do đó, ông đã đưa ra kết luận rằng các hạt phát ra từ ca-tốt trong thí nghiệm này tồn tại phổ biến của vật chất. 
            Vào thời điểm ấy, Thomson gọi các hạt này là các vi thể còn cái tên electron được George Stoney đề xuất vào thời điểm trước 
            đấy cho đơn vị cơ bản của điện tích âm đã được chấp nhận rộng rãi. <p>
            <p class='styled-paragraph'>Với những đóng góp to lớn của ông, J.J. Thomson đã nhận giải thưởng Nobel Vật lý vào năm 1906. </p>
            <p class='styled-paragraph'> Như vậy, với thí nghiệm của J.J Thomson, các nhà khoa học đã tiến thêm một bước lớn trong Vật lý nguyên tử, tạo nên cơ sở vững chắc 
